...
import {
  ...
  Tag, Megaphone, Star, Gift, Users, LogOut, Menu, X, MessageSquare, Dumbbell, Building2,
} from 'lucide-react'
...
const navItems = [
  ...
  { href: '/admin/planos',        label: 'Planos',      icon: Dumbbell },
  { href: '/admin/franquias',     label: 'Franquias',   icon: Building2 },
