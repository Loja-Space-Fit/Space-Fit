...
export default function BotaoLimpezaBanco() {
  ...
  const itens = [
    { label: 'Pedidos pendentes com +30 dias serão excluídos', count: contagem?.pedidos_pendentes },
    { label: 'Cupons expirados serão desativados',             count: contagem?.cupons_expirados },
    { label: 'Avaliações não aprovadas com +60 dias serão excluídas', count: contagem?.avaliacoes_antigas },
  ]
